export default function Fortnite() {
  return (
    <div className="min-h-screen p-8">
      <h1 className="text-center font-bold text-4xl text-blue-500">Fortnite</h1>
      <p className="text-lg mt-4 text-center text-blue-500">Welcome to the Fortnite section!</p>
      <p className="mt-2 text-lg text-center text-blue-500">Here you can find all Fortnite-related content.</p>
